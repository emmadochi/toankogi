...
<head>
    ...
    <title>TOAN Kogi State | Tricycle Tax & Registration</title>
    <!-- Google Fonts: Outfit -->
                ...
                <div class="container hero-grid">
                    <div class="hero-content">
                        ...
                        <div class="hero-btns">
                            ...
                            <a href="downloads.html" class="btn btn-primary">Member Resources</a>
                            <a href="about.php" class="btn btn-outline">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="slide-bg" style="background-image: linear-gradient(rgba(15, 23, 42, 0.6), rgba(15, 23, 42, 0.6)), url('images/keke.jpeg');"></div>
            </div>
            <!-- Slide 2: Why Pay Tax -->
            <div class="slide">
                <div class="container hero-grid">
                ...
                <div class="slide-bg" style="background-image: linear-gradient(rgba(15, 23, 42, 0.6), rgba(15, 23, 42, 0.6)), url('images/keke1.jpeg');"></div>
            </div>
            <!-- Slide 3: Impact -->
            <div class="slide">
                <div class="container hero-grid">
                ...
                <div class="slide-bg" style="background-image: linear-gradient(rgba(15, 23, 42, 0.6), rgba(15, 23, 42, 0.6)), url('images/outreach.jpeg');"></div>
            </div>
        </div>
    ...
    <section id="about" class="about">
        <div class="container about-grid">
            <div class="about-image">
                <img src="images/look.jpeg" alt="About TOAN Kogi" class="glass-border-img">
            </div>
        ...
        <div class="container">
            ...
            <div class="blog-grid">
                <article class="blog-card glass">
                    <div class="blog-img">
                        <img src="images/outreach2.jpeg" alt="Better Roads">
                    </div>
                ...
                <article class="blog-card glass">
                    <div class="blog-img">
                        <img src="images/withformergov.jpeg" alt="Secure Parks">
                    </div>
                    <div class="blog-content">
    ...
    <section id="roadmap" class="workflow">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 4rem;">
                <a href="contact.php" class="btn btn-primary">Find Nearest Registration Center</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item glass">
                    ...
                    <img src="images/outreach.jpeg" alt="Gallery 1">
                    <div class="gallery-overlay"><h4>New Parks</h4></div>
                </div>
                <div class="gallery-item glass">
                    <img src="images/look.jpeg" alt="Gallery 2">
                    <div class="gallery-overlay"><h4>Digital Hubs</h4></div>
                </div>
                <div class="gallery-item glass">
                    <img src="images/withformergov.jpeg" alt="Gallery 3">
                    <div class="gallery-overlay"><h4>Member Success</h4></div>
                </div>
                <div class="gallery-item glass">
                    <img src="images/outreach2.jpeg" alt="Gallery 4">
