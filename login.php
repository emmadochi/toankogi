...
<head>
    ...
    <title>Member Login | TOAN Kogi State</title>
    <!-- Google Fonts: Outfit -->
    ...
    <div class="login-card" style="border-top: 5px solid var(--accent-red);">
        <div class="login-header">
            <a href="index.php" style="text-decoration: none;">
                <img src="images/logo.jpeg" alt="TOAN Logo" class="login-logo-img">
        ...
        <form id="login-form">
            <div class="form-group" style="margin-bottom: 2rem;">
                ...
                <input type="text" placeholder="e.g. KOG-123-AB" required style="padding: 1.2rem 1.5rem;">
            </div>
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="password" placeholder="••••••••" required style="padding: 1.2rem 1.5rem;">
            </div>
        ...
        <div class="login-footer">
            <p>Don't have an account? <a href="contact.php">Visit Registration Hub</a></p>
