...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-trend trend-up">↑ Real-time tracking</div>
    </div>
    <div class="stat-card">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(lgaCtx, {
        type: 'doughnut',
        data: {
            labels: [<?php foreach($data['lgaRevenue'] as $lga) echo "'$lga->name',"; ?>],
            datasets: [{
                data: [<?php foreach($data['lgaRevenue'] as $lga) echo ($lga->total ?? 0) . ","; ?>],
                backgroundColor: [
