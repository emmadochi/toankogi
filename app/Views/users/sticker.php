...
<!-- Sticker Container with Horizontal Scroll for Mobile -->
<div style="width: 100%; overflow-x: auto; padding: 2rem 0; display: flex; justify-content: center; -webkit-overflow-scrolling: touch;">
    <!-- The Sticker Container (Landscape) -->
    <div id="keke-sticker" style="min-width: 600px; width: 600px; height: 380px; background: white; border-radius: 15px; box-shadow: 0 20px 50px rgba(0,0,0,0.1); border: 2px solid #eee; position: relative; overflow: hidden; display: flex; flex-direction: column;">
...
/* Hide scrollbar for the sticker container horizontally but keep functionality */
