...
<div class="action-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-bottom: 3rem;">
    <!-- Receipt Card -->
    <div class="card" style="padding: 1.5rem; display: flex; align-items: center; gap: 1.5rem; transition: 0.3s; cursor: pointer;" onclick="window.location.href='receipt.php?id=<?php echo $member_id; ?>&name=<?php echo urlencode($member_name); ?>&plate=<?php echo $plate_no; ?>'">
    ...
    <!-- Keke Sticker Card -->
    <div class="card" style="padding: 1.5rem; display: flex; align-items: center; gap: 1.5rem; transition: 0.3s; cursor: pointer;" onclick="window.location.href='sticker.php?id=<?php echo $member_id; ?>&name=<?php echo urlencode($member_name); ?>&plate=<?php echo $plate_no; ?>'">
    ...
    <!-- ID Card Card -->
    <div class="card" style="padding: 1.5rem; display: flex; align-items: center; gap: 1.5rem; transition: 0.3s; cursor: pointer;" onclick="window.location.href='id_card.php?id=<?php echo $member_id; ?>&name=<?php echo urlencode($member_name); ?>&plate=<?php echo $plate_no; ?>'">
...
<div style="text-align: center; border-top: 1px solid var(--glass-border); padding-top: 2rem;">
    <a href="dashboard.php" class="btn btn-outline" style="margin-right: 1rem;">Back to Dashboard</a>
    <a href="registration.php" class="btn btn-primary">Register Another Member</a>
</div>
